...
INSERT INTO `u7417506_dosyatakip`.`file` (`id`,`name`,`required_forms`,`acente_id`,`personel_id`,`avukat_id`,`lastinsetdate`,`createdate`,`modifydate`,`deletedate`,`order`) VALUES (UNHEX('86bfd5c3725492fbe359eedac863a324'),'Avukatlık','',UNHEX('11d8dbc5f4cfd1084da2c48d838c6ce1'),UNHEX('e45fd2ee4e4a5167a99117a9be1876aa'),UNHEX('4b9a5dcef97c279fded0e89fe098a64d'),'2020-12-04 15:33:12','2020-12-04 15:33:12','2020-12-07 14:30:38',NULL,'4');
...
INSERT INTO `u7417506_dosyatakip`.`form_notes` (`id`,`file_id`,`user`,`text`,`type`,`createdate`,`modifydate`,`deletedate`) VALUES (UNHEX('73d9f2a466e5b10e21da1032583ef628'),UNHEX('305119376d9cb88acd5be82400a02a64'),UNHEX('a4fa877d9c9fbcfb2ad39eaa62c9f5ba'),'Adli tıptan belge geldi','Adli Tıp','2020-12-07 14:32:08',NULL,NULL);
...
INSERT INTO `u7417506_dosyatakip`.`values` (`id`,`formid`,`field`,`text`) VALUES (UNHEX('72c4e697fd138988ac6dfd7d1b6f8580'),UNHEX('d286bdfdd13cf8825ca0d25b77f4d2ae'),UNHEX('21d25dcf24373baeb847f52815bbd746'),'3CA6C3A96185B20FB28088A0455F700B');
